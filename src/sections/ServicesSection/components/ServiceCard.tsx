      ...
      >
        ...
        <div className="text-sm bg-no-repeat box-border caret-transparent leading-[21px] md:text-base md:leading-6">
          ...
          <div className="text-[12.25px] bg-no-repeat box-border caret-transparent float-left leading-[12.25px] mr-[6.125px] mb-[3.0625px] md:text-sm md:leading-[14px] md:mr-[7px] md:mb-[3.5px]">
            ...
            >
              <span className="relative text-yellow-500 text-[12.25px] font-bold bg-no-repeat box-border caret-transparent block leading-[12.25px] order-2 px-[18.375px] py-[14.0017px] font-red_hat_text md:text-sm md:leading-[14px] md:px-[21px] md:py-[16.002px] flex items-center gap-2">
                {ctaLabel}
                <svg
                  className="w-3 h-3 text-yellow-500 transform transition-transform duration-300 group-hover:translate-x-1"
                  viewBox="0 0 20 20"
                  fill="currentColor"
